...
def get_parser():
    ...
    parser.add_argument('--sample-only', type=int, default=10000, help="sample the specified number from the model in each loop")
...
if __name__ == '__main__':
    ...
    if initial_gen == 0:
        ...
        subprocess.run(["julia", "--project=.", "search_fc.jl", args.dump_path, str(args.nb_local_searches), str(args.num_initial_empty_objects), str(args.final_database_size), str(args.target_db_size)])
    ...
    #            print_samples(num=10)
        ...
        subprocess.run(["julia", "--project=.", "search_fc.jl", args.dump_path, str(args.nb_local_searches), str(args.num_initial_empty_objects), str(args.final_database_size), str(args.target_db_size), '-i', args.dump_path + '/transformer-output-decoded.txt'])
